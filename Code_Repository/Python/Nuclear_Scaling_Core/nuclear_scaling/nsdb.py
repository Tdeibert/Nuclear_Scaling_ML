...
# Package layout (2026-09-22): <Code_Repository>/Python/Nuclear_Scaling_Core/nuclear_scaling/nsdb.py
# The database lives in the data root; schema/views SQL live in Code_Repository/Python/Database.
PYTHON_DIR = Path(__file__).resolve().parents[2]      # Code_Repository/Python
DATA_ROOT = Path(os.environ.get("NUCLEAR_SCALING_ROOT",
                 f"/data/user/{os.environ.get('USER', 'tdeibert')}/Nuclear_Scaling"))
DEFAULT_DB = DATA_ROOT / "Database" / "nuclear_scaling.db"
DEFAULT_VIEWS_SQL = PYTHON_DIR / "Database" / "views.sql"
