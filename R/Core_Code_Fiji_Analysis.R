...
# Load dataset
df <- read.csv("C:/Users/tdeibert/Documents/UWYO/Nuclear Scaling Project/Data Sets/Control/Extract 3/Bulk Image Analysis All Time Points/T1.csv")

# Extract X and Y columns for clustering
xy_data <- df[, c("XM", "YM")]

# Run DBSCAN clustering
db <- dbscan(xy_data, eps = 10, minPts = 1)
print(db)
